    ...
    return (
        <>
            <BreadcrumbLayout
             ...
             />
            <h1 className="text-xl text-center sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-2 sm:mb-3 md:mb-4">
                Мой профиль
            </h1>
            <p className="text-sm text-center sm:text-base md:text-lg text-muted-foreground px-2">
