...
export function ClientSearchInputs() {
    ...
    return (
        ...
        <form
            ...
            className="bg-card px-4 sm:px-6 md:px-20 w-full flex flex-col gap-4 sm:gap-6 my-8 sm:my-12 md:my-20 rounded-xl p-4 sm:p-6 md:p-8 shadow-lg"
        >
            ...
            <div className="flex items-center w-full justify-center cursor-pointer text-center gap-2 text-muted-foreground font-medium text-sm py-2" onClick={() => setOpenOptionals(!openOptionals)}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2 sm:pt-4">
                <Button
                    type="submit"
                    className="w-full sm:flex-1 bg-rose-600 hover:bg-rose-700 text-white h-11 font-semibold"
                >
